...
class UriViewHelper extends AbstractTagBasedViewHelper
{
    ...
    {
        $uriBuilder = $this->renderingContext->getControllerContext()->getUriBuilder();// @phpstan-ignore-line
        $extensionName = $this->renderingContext->getControllerContext()->getRequest()->getControllerExtensionName();// @phpstan-ignore-line
        $pluginName = $this->renderingContext->getControllerContext()->getRequest()->getPluginName();// @phpstan-ignore-line
